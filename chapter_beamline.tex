...
\begin{figure}
	...
	\caption[CAD render of the TABLe]{Render of the Transient Absorption Beamline (TABLe).}
...
\begin{figure}
	\centering
	\includegraphics[width=1.0\textwidth]{figures/Beamline/CAD_beamline_layout.pdf}
	\caption[CAD render of the TABLe]{CAD render of the TABLe}
	\label{fig:CAD_render_TABLe_layout}
\end{figure}
...
\begin{figure}
	\centering
	\includegraphics[width=1.0\textwidth]{figures/Beamline/CAD_spectrometer.pdf}
