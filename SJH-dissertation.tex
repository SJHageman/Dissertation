...
\newcommand{\dod}{\ensuremath{\Delta\mathrm{OD}}}
...
\include{abstract}
\dedication{Dedicated to Jarrett J. Hill} % Optional, and seriously not this lame
...
\mainmatter
%\include{chapter_outline}
\include{chapter_introduction}
\include{chapter_beamline}
\include{chapter_swpg}
\include{chapter_refractive_index}
\include{chapter_ATS}
\include{chapter_CATS}
\include{chapter_conclusion}
%\begin{appendices}
%	\include{appendix_SWPG}
%	\include{appendix_ATS}
%\include{appendix1}
%\include{appendix_TOPAS}
%\end{appendices}
