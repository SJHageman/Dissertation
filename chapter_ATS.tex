...
\label{sec:LIA}
An additional term in the DCM that can be explicitly calculated for a dressing pulse of finite pulse duration is the non-resonant amplitude $a_1$.  As stated previously, this term is related to the population of the state, and its time and delay dependence is related to the direct ionization of the discrete state.  
