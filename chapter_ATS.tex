...
\end{equation}
This form of the dipole can be understood intuitively as arising naturally from the two interfering processes that are occusing: direct ionization and autoionization.  The first $\delta$-function in equation \ref{eqn:dipole_time_domain} represents direct ionization to the continuum, and the second term represents decay from the bound state to the continuum with a lifetime of $\hbar/\Gamma$.  A schematic of the dipole after an impulsive XUV pulse is shown in  figure \ref{fig:dipole_sketch}.
\begin{figure}
	\centering
	\includegraphics[width=1.0\textwidth]{figures/ATS/dipole_sketch.pdf}
	\caption{Illustration of the dipole moment after a $\delta(t)$ excitation pulse.}
