...
\begin{equation}
\begin{aligned}
	d(t,\tau)&=\braket{\Psi(t,\tau)|\hat{\mu}_X|\Psi(t,\tau)}\\
	&=\sum_{\alpha,m,n}e^{-i(\epsilon_\alpha+m\omega)t}e^{i(n-m)\omega\tau} \braket{\phi_{\alpha,n}|\hat{\mu}_X|g} \braket{g|\hat{\mu}_X|\phi_\alpha,m} + c.c.
\end{aligned}
\end{equation}
...
\begin{figure}
	...
	\caption[Floquet energies as a function of Rabi frequency and time.]{Incomplete}
