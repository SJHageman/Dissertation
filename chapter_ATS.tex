...
\end{equation}
where $I_10$ is the 10x10 identity matrix and $\omega_{nl}$ are energies of each $nl$ resonance.  Additionally, in the same basis the matrix $H_{\pm1}$ takes the form
\begin{equation}
