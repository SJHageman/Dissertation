...
\end{equation}
This form of the dipole can be understood intuitively as arising naturally from the two interfering processes that are occusing: direct ionization and autoionization.  The first $\delta$ function in equation \ref{eqn:dipole_time_domain} represents direct ionization to the continuum, and the second term in 
\begin{figure}
	\centering
